...
define view entity zi_fe_conn_001521
  as select from zfe_aconn_001521 as Connection
  association [1..1] to zi_fe_carr_001521 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
