CLASS ztg3_cl_gen_Data DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ztg3_cl_gen_Data IMPLEMENTATION.
...
*   clear data
    DELETE FROM ztg3_atrav.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT ztg3_atrav  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ztg3_atrav. | ).
  ENDMETHOD.
ENDCLASS.
