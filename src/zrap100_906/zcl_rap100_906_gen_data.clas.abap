CLASS zcl_rap100_906_gen_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_906_gen_data IMPLEMENTATION.
 METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '906',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav906.

    "insert travel demo data
    INSERT zrap100_atrav906  FROM (
        SELECT
